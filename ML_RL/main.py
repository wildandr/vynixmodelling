...
VISUALIZATION_PARAMS = {
    ...
    'save_png': True,                  # Simpan dalam format PNG (akan menginstal kaleido otomatis)
...
logging.info(f"Triple Barrier results saved to: {triple_barrier_output_path}")
print(f"Triple Barrier results saved to: {triple_barrier_output_path}")
...
print(f"\n=== Final Summary ===")
print(f"Processed data shape: {filtered_df.shape}")
...
print("\nAll preprocessing and labeling completed successfully!")
