...
def combined_xgb_hmm_objective(trial):
    ...
    try:
        ...
        xgb_params = {
            ...
            'colsample_bylevel': trial.suggest_float('colsample_bylevel', 0.6, 1.0, step=0.01),  # Dropout level-wise
            'colsample_bynode': trial.suggest_float('colsample_bynode', 0.6, 1.0, step=0.01),   # Dropout node-wise
